...
/*--
 • truck_details用のデータ準備 (vignette-1で使用)
--*/
...
/*
-- ========================================
-- [コメントアウト] ハンズオンの対象外のため省略
-- Cortex AI / セマンティックレイヤー / レビューデータ関連
-- ========================================
